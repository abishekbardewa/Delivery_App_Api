...
<div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-3" id="dashboardArea">
<h6 class="font-size-base text-light mb-0">Dashboard <small><?=$this->data['company']?></small></h6>
